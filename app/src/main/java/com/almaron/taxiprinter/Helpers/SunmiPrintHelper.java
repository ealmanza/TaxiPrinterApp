...
import com.almaron.taxiprinter.Utilities.ESCUtil;
...
public class SunmiPrintHelper {
     ...
     */
    public void printText(String content, float size, boolean isBold, boolean isUnderLine, int alignment) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
     ...
     */
    public void printTable(String[] txts, int[] width, int[] align, boolean isBold, float size) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
